...
--
-- `verfallsdatumPflicht` ist auf 34 Artikel gesetzt: Flüssigkeiten, Sterilgut
-- mit kurzer Frist, Klebendes und den Druckbehälter. Geräte, aufbereitbares
-- Material und Papier tragen es nicht. Das ist eine fachliche
-- Ersteinschätzung und in der Oberfläche jederzeit änderbar.
